import{H as u,C as r}from"./styled-components.browser.esm-94e9e9ef.js";const d={light:300,medium:500,bold:700},l=u.p.attrs(()=>({}))`
  ${({theme:{typography:e,palette:t},variant:a="body",color:n,type:i="medium"})=>r`
    font-family: ${e[a].fontFamily};
    letter-spacing: ${e[a].letterSpacing};
...
//# sourceMappingURL=typography-b3afb59d.js.map
